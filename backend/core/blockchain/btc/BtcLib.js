...
class BtcLib extends AbstractCurrencyLibrary {
    ...
    sendCurrency(to, amount) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let txParams = await this.formatTransactionParameters(to, amount);
                //console.log("btcLib sendCurrency formatTxParams", txParams)
                let rawTx = await this.createSignRawTx(txParams);
    ...
    formatTransactionParameters(to, amount) {
        return new Promise(async (resolve, reject) => {
            try {
